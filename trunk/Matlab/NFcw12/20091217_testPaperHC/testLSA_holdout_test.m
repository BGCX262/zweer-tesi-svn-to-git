function [] = testLSA_holdout_test (urm,icmItemModel,percentageTest,profileLength)
...
addpath(genpath('/home/turrin/matlab/Engineering'));
    ...
    fileNameLSA = ['rmseLSA_holdout_TEST_',mat2str(profileLength),'.mat'];
    if fileExist(fileNameLSA) load(fileNameLSA); end    

    tic

    onlineParamSvd.valueToAdd=2.5; %test
...
% (urmConfronto)
    ...
    ls =150
    model.ls = ls;
    [positiveTests,negativeTests]=holdOut('/home/turrin/matlab/Engineering/lsaCosine', @createModel_lsaCosine, @onLineRecom_lsaCosine_test,urm,urmTrain,positiveTestsetReturn,negativeTestsetReturn,model,onlineParamSvd);        
