...
addpath('/home/turrin/matlab/Engineering');
    ...
    lsLSA = 150
    model.ls=lsLSA;
    [positiveTests,negativeTests,positiveTestsetReturn,negativeTestsetReturn,indexexOfFoldsPos,indexexOfFoldsNeg]=kfolder(folds,'/home/turrin/matlab/Engineering/lsaCosine', @createModel_lsaCosine, @onLineRecom_lsaCosine_test,urm,model,1,positiveTestsetReturn,negativeTestsetReturn);
