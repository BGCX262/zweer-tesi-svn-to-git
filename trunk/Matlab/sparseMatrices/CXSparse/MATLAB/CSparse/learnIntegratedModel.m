function [bu,bi,q,x,y,p,z] = learIntegratedModel (urm,mu,bu,bi,iterations,lrate,lambda,q,x,y,p,z)                                               %#ok
...
warning ('learnFactorModel mexFunction not found') ;
...
if (nargout>5 & nargin>11)
    useruser=true;
    display('user-user model enabled');
end
