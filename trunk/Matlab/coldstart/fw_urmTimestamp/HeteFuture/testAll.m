function [] = testAll (refDay,days,numGiorniTest,urm,daysToJump)
...
%    end
    ...
    trainURM = generateURMfromTimestampFull(urm,datestr(addtodate(datenum(refDay,'dd/mm/yyyy'),+prev,'day'),'dd/mm/yyyy')); %A(t_0)
    actualURM = generateURMfromTimestampCompactUsersItemsFull(urm,datestr(addtodate(datenum(refDay,'dd/mm/yyyy'),+day,'day'),'dd/mm/yyyy'),datestr(addtodate(datenum(refDay,'dd/mm/yyyy'),+prev,'day'),'dd/mm/yyyy')); %A(t) 
