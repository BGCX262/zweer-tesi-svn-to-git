...
for j=1:length(days)
    ...
    actualURM = generateURMfromTimestampCompactUsersItemsFull(urm,datestr(addtodate(datenum('07/04/2008','dd/mm/yyyy'),+day,'day'),'dd/mm/yyyy'),datestr(addtodate(datenum('07/04/2008','dd/mm/yyyy'),+prev,'day'),'dd/mm/yyyy')); %A(t) 
