function [] = testAll (days,urm, referenceDay)
...
[positiveTests,negativeTests,positiveTestsetReturn,negativeTestsetReturn,indexexOfFoldsPos,indexexOfFoldsNeg]=kfolder(folds,'/home/turrin/matlab/Engineering/topRated', @createModel_toprated, @onLineRecom_toprated,generateURMfromTimestamp(urm,datestr(addtodate(datenum('01/09/2008','dd/mm/yyyy'),-referenceDay,'day'),'dd/mm/yyyy')),1,1,0.2,-1);
save('testSet', 'positiveTestsetReturn','negativeTestsetReturn');

for i=days;
    tic;
    i
    [positiveTests,negativeTests,positiveTestsetReturn,negativeTestsetReturn,indexexOfFoldsPos,indexexOfFoldsNeg]=kfolder(folds,'/home/turrin/matlab/Engineering/topRated', @createModel_toprated, @onLineRecom_toprated,generateURMfromTimestamp(urm,datestr(addtodate(datenum('01/09/2008','dd/mm/yyyy'),-i,'day'),'dd/mm/yyyy')),1,1,positiveTestsetReturn,negativeTestsetReturn);
