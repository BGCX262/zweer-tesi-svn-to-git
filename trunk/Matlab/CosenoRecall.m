function [id_dist_id]=CosenoRecall(pathUrm,i,typeOfTest)
...
if i==1
%    M=dir(strcat(pathUrm,'IIcos1half.mat'));
	M=dir(strcat(pathUrm,'DRcoshalf1BINpos.mat'));
    load(strcat(pathUrm,M.name));
    II = DRcosNFhalf1BINpos ;
    %clear DRcosNFhalf1BINpos ;
    ...
    M=dir(strcat(pathUrm,'UleaveOO2perctrasp2half.mat'));
    load(strcat(pathUrm,M.name));
    urmTestLooTrasp = UleaveOOtrasp2half;
    clear UleaveOOtrasp2half;
 ...
 %   M=dir(strcat(pathUrm,'IIcos2half.mat'));
    M=dir(strcat(pathUrm,'DRcoshalf2BINpos.mat'));
    load(strcat(pathUrm,M.name));
    II = DRcosNFhalf2BINpos;
    clear DRcosNFhalf2BINpo;
    ...
    M=dir(strcat(pathUrm,'UleaveOO2perctrasp1half.mat'));
    load(strcat(pathUrm,M.name));
    urmTestLooTrasp = UleaveOOtrasp1half;
    clear UleaveOOtrasp1half;
end
