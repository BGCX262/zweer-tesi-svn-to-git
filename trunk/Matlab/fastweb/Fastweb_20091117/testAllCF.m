function [] = testAllCF (urm,percentageTest)
...
%%%%%%%%%%%% DR
    ...
    save('recallDrTmp','recallDr50', 'recallDr10');
    ...
    save('recallDr','recallDr150','recallDr100','recallDr50', 'recallDr10');
